...
namespace RenderSharp.Renderer
{
    public sealed class ShaderRenderer : IShaderRunner, ISceneRenderer
    {
        ...
        private readonly Func<ShaderScene, ReadOnlyBuffer<ShaderSphere>, RayTraceShader> _shaderFactory;
        ...
        {
            _gpu = gpu;
            _shaderFactory = static (s, g) => new RayTraceShader(s, g);
        }
        ...
        {
            _gpu.ForEach(texture, _shaderFactory(_scene, _geometryBuffer));
        }
    }
}
